...
switch (encodedString) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      // if (subfolderName.folders.length == 0) {
      //   console.log(subfolderName.items);
        // return subfolderName.items;

      // } else {
      //   console.log(subfolderName.folders);

      //   return subfolderName.folders ;
      // }
    ...
    error: function (error) {
      return error;// Handle any errors that occur during the API call
    },
  });
  // return folders;
